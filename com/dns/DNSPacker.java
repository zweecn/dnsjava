...
public class DNSPacker {
	...
	public DNSPacker(byte[] queryBytes) {
		this.queryBytes = queryBytes;
		this.ipmap = new HashMap<InetAddress, InetAddress>();
		this.iplList = new ArrayList<String>();
	}
	
	public DNSPacker(byte[] queryBytes, Record[] records, Map<InetAddress, InetAddress> ipmap) {
		this.queryBytes = queryBytes;
	...
	public DNSPacker(byte[] queryBytes, Record[] records, String[] cname, Map<InetAddress, InetAddress> ipmap) {
		this.queryBytes = queryBytes;
		this.records = records;
		this.ipmap = ipmap;
		this.cname = cname;
	...
	public byte[] getDNSServerNameData(String dnsName) {
	...
	public byte[] getPTRRecordResponseData(String hostip) {
		List<Byte> resBytes = new ArrayList<Byte>();
		// 将请求数据封入首部
		for (byte b : queryBytes) {
			resBytes.add(b);
